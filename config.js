...
global.sgh = 'https://github.com/ela'
...
/*============== WATERMARK ==============*/
global.wm = 'Elaina Botzラ | By F4Q Store' //Main Watermark
global.wm2 = 'By F4Q Store'
global.wm3 = 'Elaina Botzラ | By F4Q Store'
global.botdate = `⻝ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⻝ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `⻝ 𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `Elaina Botzラ | By F4Q Store`
global.author = 'By F4Q Store' 
global.packname = 'By F4Q Store'
...
/*============== GLOBAL BIO ==============*/
global.nameowner = 'F4Q Store'
global.umurowner = '16'
global.asalowner = 'Amerika Serikat, New York'
global.nomorowner = 'wa.me/6285831796696'
global.pacarowner = 'Kepo amat sih;v'

/*============== TEXT ==============*/
global.wait = '```Bentar Euy...```'
global.eror = '```Yah Error```'
